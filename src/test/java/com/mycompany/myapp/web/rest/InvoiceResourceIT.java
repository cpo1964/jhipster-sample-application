...
import static com.mycompany.myapp.domain.InvoiceAsserts.*;
...
class InvoiceResourceIT {
    ...
    private static final String DEFAULT_INVOICE_NR = "AAAAAAAAAA";
    private static final String UPDATED_INVOICE_NR = "BBBBBBBBBB";
    ...
    public static Invoice createEntity() {
        return new Invoice().invoiceNr(DEFAULT_INVOICE_NR).invoiceDate(DEFAULT_INVOICE_DATE);
    }
    ...
    public static Invoice createUpdatedEntity() {
        return new Invoice().invoiceNr(UPDATED_INVOICE_NR).invoiceDate(UPDATED_INVOICE_DATE);
    }
    ...
    void putExistingInvoice() throws Exception {
        ...
        updatedInvoice.invoiceNr(UPDATED_INVOICE_NR).invoiceDate(UPDATED_INVOICE_DATE);
    ...
    void fullUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.invoiceNr(UPDATED_INVOICE_NR).invoiceDate(UPDATED_INVOICE_DATE);
