...
describe('Service Tests', () => {
  describe('Invoice Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Invoice(123, 'AAAAAAA', currentDate);
    });

    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = { invoiceDate: dayjs(currentDate).format(DATE_TIME_FORMAT), ...elemDefault };
      ...
      it('should create a Invoice', async () => {
        const returnedFromService = { id: 123, invoiceDate: dayjs(currentDate).format(DATE_TIME_FORMAT), ...elemDefault };
      ...
      it('should update a Invoice', async () => {
        const returnedFromService = { invoiceNr: 'BBBBBB', invoiceDate: dayjs(currentDate).format(DATE_TIME_FORMAT), ...elemDefault };
      ...
      it('should partial update a Invoice', async () => {
        const patchObject = { invoiceDate: dayjs(currentDate).format(DATE_TIME_FORMAT), ...new Invoice() };
